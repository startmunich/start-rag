...
class EmbeddingTest(unittest.TestCase):
    ...
    def test_infinity_embedding(self):
        ...
        # calculates the similarity of 2 vector using the cosine distance
        ...
        print(result_13)
        print(result_23)
        # the vectors 2 and 3 should be more similar thant the vectors 1and 2 or 1 and 3
...
class QdrantTest(unittest.TestCase):
    ...
    def test_post_data(self):
        ...
        output = QdrantTest.find_elements_by_ids(self, 0, 3)
    ...
    def test_delete_data(self):
        ...
        del_elem = QdrantTest.find_elements_by_ids(self, 0, 3)
    ...
    def test_retrievel_of_points(self):
        ...
        for x in range(0, 3):
            ...
            # retrieve the point
            point = QdrantTest.find_elements_by_ids(self, x, x+1)[0]
    ...
    def find_elements_by_ids(self, lower_id, upper_id):
        output = []
    ...
    def delete_elements_by_id(self, lower_id, upper_id):
        output = []
        for x in range(0, 3):
            result= qdrant_client.delete(collection_name=qdrant_collection_name,

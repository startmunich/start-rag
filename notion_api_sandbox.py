...
#             callout_text = ''
#             for text_segment in block['callout']['rich_text']:
#                 callout_text += text_segment['text']['content']
#             print('Callout content: ', callout_text)
#         else:
#             print('Block content: ', block['type'])  # Modify this line to handle other block types as needed
